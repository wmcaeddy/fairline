<header class="header clearfix" style="background: var(--color-primary); display: flex; align-items: center; justify-content: space-between; padding: 10px 20px;">
  <div style="display: flex; align-items: center; width: 100%;">
      ...
      <div class="search-bar" style="flex: 1; max-width: 600px; display: flex; margin-right: 20px;">
          <input type="text" placeholder="輸入商品名稱或關鍵字" style="width: 100%; padding: 8px 12px; border: none; border-radius: 2px 0 0 2px; outline: none;">
          <button style="background: #fff; border: none; border-left: 1px solid #ddd; border-radius: 0 2px 2px 0; padding: 0 15px; color: #333; cursor: pointer;">
